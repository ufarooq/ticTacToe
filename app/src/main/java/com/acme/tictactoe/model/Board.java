...
public class Board {
  ...
  /**
   * Mark the current row for the player who's current turn it is. Will perform no-op if the
   * arguments are out of range or if that position is already played. Will also perform a no-op if
   ...
   *     <code>currentCol</code> has a tic tac toe.
   */
